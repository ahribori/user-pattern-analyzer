            ...
            const result = await (async function (browser) {
                switch (action.type.toUpperCase()) {
                    ...
                    case actionTypes.FRAME:
                        ...
                        break;
                    case actionTypes.WINDOW_HANDLE_FULLSCREEN:
                        await browser.windowHandleFullscreen();
                    case actionTypes.WINDOW_HANDLE_MAXIMIZE:
                        await browser.windowHandleMaximize();
                    case actionTypes.WINDOW_HANDLE_POSITION:
                        await browser.windowHandlePosition({
                            x: action.x,
                            y: action.y
                        });
                    case actionTypes.WINDOW_HANDLE_SIZE:
                    ...
                    case actionTypes.SCREENSHOT:
                        await browser.saveScreenshot(path.resolve(appPath.SCREENSHOT_PATH, `${action.title || Date.now()}.png`));
                        break;
